...
namespace Students.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        {
            //  Console.WriteLine("hello external auth");
            var payload = await _jwtHandler.VerifyGoogleToken(externalAuth);
            //Console.WriteLine($"payload: {payload.Email}");
            ...
            Console.WriteLine($"user info: {info.ProviderDisplayName}");
            Console.WriteLine($"user info: {info.ProviderKey}");
            ...
            return Ok(new AuthResponseDto { Token = token, IsAuthSuccessful = true, Email = payload.Email });
        }
    }
}
